...
@XmlRootElement(name = "GetPicNumberResponse")
public class GetPicNumberResponse {

    @XmlElement(name = "LabelNumberResponse")
    protected LabelNumberResponse labelNumberResponse;

    /**
     * Gets the value of the labelNumberResponse property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the labelNumberResponse property.
     * 
     * @param value
     *     allowed object is
     *     {@link LabelNumberResponse }
