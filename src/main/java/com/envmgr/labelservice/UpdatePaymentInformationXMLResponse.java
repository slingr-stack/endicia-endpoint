...
@XmlRootElement(name = "UpdatePaymentInformationXMLResponse")
public class UpdatePaymentInformationXMLResponse {

    @XmlElement(name = "UpdatePaymentInfoResponse")
    protected UpdatePaymentInfoResponse updatePaymentInfoResponse;

    /**
     * Gets the value of the updatePaymentInfoResponse property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the updatePaymentInfoResponse property.
     * 
     * @param value
     *     allowed object is
     *     {@link UpdatePaymentInfoResponse }
