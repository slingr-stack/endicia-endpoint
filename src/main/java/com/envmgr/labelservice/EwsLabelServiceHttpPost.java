...
public interface EwsLabelServiceHttpPost {
    ...
    @WebMethod(operationName = "CreateShipmentNotificationRequestXML")
    @WebResult(name = "CreateShipmentNotificationResult", targetNamespace = "www.envmgr.com/LabelService", partName = "Body")
    public CreateShipmentNotificationResult createShipmentNotificationRequestXML(
        @WebParam(partName = "createShipmentNotificationRequestXML", name = "createShipmentNotificationRequestXML", targetNamespace = "")
