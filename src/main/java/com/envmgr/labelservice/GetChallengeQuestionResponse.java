...
@XmlRootElement(name = "GetChallengeQuestionResponse")
public class GetChallengeQuestionResponse {

    @XmlElement(name = "ChallengeQuestionResponse")
    protected ChallengeQuestionResponse challengeQuestionResponse;

    /**
     * Gets the value of the challengeQuestionResponse property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the challengeQuestionResponse property.
     * 
     * @param value
     *     allowed object is
     *     {@link ChallengeQuestionResponse }
