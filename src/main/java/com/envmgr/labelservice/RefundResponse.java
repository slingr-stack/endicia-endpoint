 ...
 *         &lt;element name="Refund" type="{www.envmgr.com/LabelService}LabelResponse" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class RefundResponse {
    ...
    protected List<LabelResponse> refund;
     ...
     * 
     */
    public List<LabelResponse> getRefund() {
        if (refund == null) {
            refund = new ArrayList<LabelResponse>();
        }
        return this.refund;
    }
