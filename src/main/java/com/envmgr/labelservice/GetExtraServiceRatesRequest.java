 ...
 *         &lt;element name="DateAdvance" type="{http://www.w3.org/2001/XMLSchema}int"/&gt;
...
@XmlType(name = "GetExtraServiceRatesRequest", propOrder = {
    "requestID",
    "dateAdvance",
    "requesterID",
    "certifiedIntermediary"
})
public class GetExtraServiceRatesRequest
    extends DataValidator
{

    @XmlElement(name = "RequestID")
    protected String requestID;
    @XmlElement(name = "DateAdvance")
    protected int dateAdvance;
