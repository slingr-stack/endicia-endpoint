...
/**
 * <p>Clase Java para GetBrandingRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="GetBrandingRequest"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GetBrandingRequest", propOrder = {
    "requesterID",
    "certifiedIntermediary"
})
public class GetBrandingRequest
