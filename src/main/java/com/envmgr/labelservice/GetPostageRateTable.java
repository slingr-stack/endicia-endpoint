...
@XmlRootElement(name = "GetPostageRateTable")
public class GetPostageRateTable {

    @XmlElement(name = "PostageRateRequest")
    protected PostageRateRequest postageRateRequest;

    /**
     * Gets the value of the postageRateRequest property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the postageRateRequest property.
     * 
     * @param value
     *     allowed object is
     *     {@link PostageRateRequest }
