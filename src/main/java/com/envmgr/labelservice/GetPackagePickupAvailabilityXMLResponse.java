...
@XmlRootElement(name = "GetPackagePickupAvailabilityXMLResponse")
public class GetPackagePickupAvailabilityXMLResponse {
    ...
    /**
     * Gets the value of the packagePickupAvailabilityResponse property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the packagePickupAvailabilityResponse property.
     * 
     * @param value
     *     allowed object is
     *     {@link PackagePickupAvailabilityResponse }
